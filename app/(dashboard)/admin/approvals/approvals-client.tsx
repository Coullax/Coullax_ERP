...
export function ApprovalsPageClient({ requests, reviewerId }: ApprovalsPageClientProps) {
  ...
  const handleViewDetails = (request: any) => {
    console.log('🔍 Admin - Request Details:', request)
    console.log('📊 Admin - Overtime Requests:', request.overtime_requests)
    console.log('✈️ Admin - Travel Requests:', request.travel_requests)
